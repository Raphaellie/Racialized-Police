...
\PassOptionsToPackage{unicode,bookmarksnumbered,
...
\hypersetup{
  pdftitle={Shades of Blue: Attitudinal Consequences of Racial Compositions of Police},
  pdfauthor={Chaoyue Wang},
  pdfsubject={Racial and Ethnic Politics; Public Opinion},
  pdfkeywords={Racial Divides; Police Brutality; Contextual Effects},
  colorlinks=true,
  linkcolor={Blue4},
  filecolor={Maroon},
  citecolor={Blue4},
...
%================Begin Manuscript==================
\newpage \clearpage \pagenumbering{arabic}\captionsetup{font = small,labelfont = bf}
